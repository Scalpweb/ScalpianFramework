...
class Database
{
	 ...
	 * @return mixed+
	 */
	public function executeQueryFromString($query, $arguments = array())
	{
	...
	/**
	 * Find all export xml files
	 */
	public function findExportsFiles()
	{
		$files = array();
		$path = ORION_MODELS_DIR . '/' . strtolower($this->getName()) . '/export';
	...
	/**
	 * Get first known database
	 * @return mixed
	 */
	static public function getMainDatabase()
	{
		$dbs = self::findDatabases();
		return self::getDatabase($dbs[0]);
	}
