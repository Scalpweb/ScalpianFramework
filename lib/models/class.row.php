...
class Row
{
    ...
    public function setLength($val)         { $this->length     = $val; } public function getLength()      { return $this->length; }
    public function setUnsigned($val)       { $this->unsigned   = $val; } public function getUnsigned()    { return $this->unsigned; }
    public function setZerofill($val)       { $this->zerofill   = $val; } public function getZerofill()    { return $this->zerofill; }
    public function setBinary($val)         { $this->binary     = $val; } public function getBinary()      { return $this->binary; }
    public function setAscii($val)          { $this->ascii      = $val; } public function getAscii()       { return $this->ascii; }
    public function setUnicode($val)        { $this->unicode    = $val; } public function getUnicode()     { return $this->unicode; }
    ...
    public function getAutoIncrement() { return $this->auto_increment; }
