...
class RelationFactory
{
    ...
    static public function create($type, $tableOne, $tableTwo, $field1, $field2, $alias, $on_delete, $on_update)
    {
        ...
        switch($type)
        {
            case RelationType::OneToOne:    return new OneToOneRelation($tableOne, $tableTwo, $field1, $field2, $alias, $on_delete, $on_update);
            case RelationType::OneToMany:   return new OneToManyRelation($tableOne, $tableTwo, $field1, $field2, $alias, $on_delete, $on_update);
            case RelationType::ManyToOne:   return new ManyToOneRelation($tableOne, $tableTwo, $field1, $field2, $alias, $on_delete, $on_update);
            case RelationType::ManyToMany:  return new ManyToManyRelation($tableOne, $tableTwo, $field1, $field2, $alias, $on_delete, $on_update);
            default:
