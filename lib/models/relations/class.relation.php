...
class Relation
{
    ...
    public function getTable1()             { return $this->table1; }
    ...
    public function getAlias($real = false) { return $real ? ($this->alias == $this->table2->getName() ? '' : $this->alias) : $this->alias; }
    public function getOnDeleteAction()     { return $this->on_delete_action; }
    public function getOnUpdateAction()     { return $this->on_update_action; }
