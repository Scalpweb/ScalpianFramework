...
class Form
{
	...
	/**
	 * Flashes errors to user
	 */
	public function flashesErrors($type)
	{
		foreach ($this->errors as $err)
		{
			User::getInstance()->flash($type, $this->formatError($err));
		}
	}
