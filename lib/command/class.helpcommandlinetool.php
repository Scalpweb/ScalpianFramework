...
class HelpCommandLineTool implements ICommandLineTool
{
    ...
    public function execute($options)
    {
        ...
        $filelist = new DirectoryIterator(ORION_LIB_DIR.'/logger/command');
        foreach($filelist as $file)
        {
            ...
            {
                require_once(ORION_LIB_DIR.'/logger/command/'.$file->getFilename());
            }
        }
    ...
    public function getDescription() 	{ return 'Show this message.'; }
