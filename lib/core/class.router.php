...
class Router extends Singleton
{
	 ...
	 * @param string $flag
	 */
	public function redirectUnless($condition, $url, $error = '', $flag = 'warning')
	{
		if (!$condition)
		{
			if($error != '')
				User::getInstance()->flash($flag, $error);
			$this->redirect($url);
		}
	}
	 ...
	 * @param string $flag
	 */
	public function redirectIf($condition, $url, $error = '', $flag = 'warning')
	{
		if ($condition)
		{
			if($error != '')
