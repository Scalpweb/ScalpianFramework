    ...
    private function put_icon_if_needed()
    {
        if(!is_null($this->refIcon)){
            ...
            switch($this->refIcon['position_left']){
                case 'left' : $this->refIcon['margin_left'] = $left; break;
                case 'right' : $this->refIcon['margin_left'] = $right; break;
                case 'center' : $this->refIcon['margin_left'] = $center_left; break;
                default : $this->refIcon['margin_left'] = 0; break;
            }

            switch($this->refIcon['position_top']){
                case 'top' : $this->refIcon['margin_top'] = $top; break;
                case 'bottom' : $this->refIcon['margin_top'] = $bottom; break;
                case 'center' : $this->refIcon['margin_top'] = $center_top; break;
                default : $this->refIcon['margin_top'] = 0; break;
            }
    ...
    private function put_text_if_needed()
    {
        if(!is_null($this->text)){
            ...
            switch($this->text['position_left']){
                case 'left' : $this->text['margin_left'] = $left; break;
                case 'right' : $this->text['margin_left'] = $right; break;
                case 'center' : $this->text['margin_left'] = $center_left; break;
                default : $this->text['margin_left'] = 0; break;
            }

            switch($this->text['position_top']){
                case 'top' : $this->text['margin_top'] = $top; break;
                case 'bottom' : $this->text['margin_top'] = $bottom; break;
                case 'center' : $this->text['margin_top'] = $center_top; break;
                default : $this->text['margin_top'] = 0; break;
            }
